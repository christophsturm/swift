...
private func swiftmutFindDescribedGenericConditionSourceLocation(
  moduleName: String,
...
private func swiftmutFindDescribedGenericConditionInFunctionBody(
  path: String,
  preferredLine: Int,
  needle: String,
  mutation: SwiftmutMutation,
...
private func swiftmutFindDescribedGenericConditionInFile(
  path: String,
  needle: String,
  mutation: SwiftmutMutation,
  config: SwiftmutConfig
...
private func swiftmutFindDescribedSourceOperatorInFile(
  path: String,
  displayRules: [SwiftmutSourceMutationDisplayRule],
  needle: String,
  config: SwiftmutConfig
...
private func swiftmutDescribedGenericConditionNeedle(_ snippet: String) -> String? {
  let bytes = Array(snippet.utf8)
  var start = swiftmutSkipHorizontalWhitespace(bytes, from: 0)
  var end = swiftmutTrimTrailingHorizontalWhitespace(bytes, end: bytes.count)
  guard start < end else {
...
private func swiftmutDescribedGenericConditionExpression(
  _ line: String,
  needle: String
) -> (column: Int, sourceOriginal: String)? {
...
private func swiftmutTernaryConditionExpression(
  _ line: String,
  needle: String
) -> (column: Int, sourceOriginal: String)? {
  let bytes = Array(line.utf8)
...
private func swiftmutTernaryConditionStart(
  bytes: [UInt8],
