...
final class SwiftmutSupportTests: XCTestCase {
  ...
  func testASCIITextHelpersAreAvailableWithoutCompilerModules() {
    ...
    XCTAssertEqual(swiftmutByteOffset(of: "beta", in: "alpha beta"), 6)
    XCTAssertEqual(swiftmutByteOffset(of: "value", in: "bé value"), 4)
    XCTAssertNil(swiftmutByteOffset(of: "", in: "value"))
    XCTAssertNil(swiftmutByteOffset(of: "missing", in: "value"))
