...
// CHECK: "line":38,"column":6},"siteKind":"condition","resultKind":"condition","alternatives":[{{.*}}"sourceOriginal":"if swiftmutConditionValue(count) == 1","sourceMutated":"if swiftmutConditionValue(count) != 1"{{.*}}"sourceOriginal":"if swiftmutConditionValue(count) == 1","sourceMutated":"if false"{{.*}}"sourceOriginal":"if swiftmutConditionValue(count) == 1","sourceMutated":"if true"{{.*}}"line":41,"column":6},"siteKind":"condition","resultKind":"condition","alternatives":[{{.*}}"sourceOriginal":"if swiftmutConditionValue(count) == 1","sourceMutated":"if swiftmutConditionValue(count) != 1"{{.*}}"sourceOriginal":"if swiftmutConditionValue(count) == 1","sourceMutated":"if false"{{.*}}"sourceOriginal":"if swiftmutConditionValue(count) == 1","sourceMutated":"if true"
