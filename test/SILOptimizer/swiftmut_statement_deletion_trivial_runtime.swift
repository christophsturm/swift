...
// CHECK: 1
// BASELINE: 2
// EVENTS: "event":"metamutantDiscovery","module":"SwiftmutStatementDeletionTrivialRuntime","function":"{{.*}}swiftmutUpdateCount
...
// EVENTS: "event":"metamutantInjection","module":"SwiftmutStatementDeletionTrivialRuntime","function":"{{.*}}swiftmutUpdateCount
...
//--- main.swift
public final class SwiftmutCounter {
...
@inline(never)
public func swiftmutUpdateCount(_ counter: SwiftmutCounter, replacement: Int) {
  counter.count = replacement
}
...
let counter = SwiftmutCounter(1)
swiftmutUpdateCount(counter, replacement: 2)
print(counter.count)
